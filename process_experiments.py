...
def processExperimentsFromConfig(configFile, libraryDirectory, generatePlots='png'):
    ...
    if generatePlots != 'off':
        ...
        # TODO: understand how to plot scatter plots
...
def computePhenotypeScore(counts1, counts2, libraryTable, growthValue, pseudocountBehavior, pseudocountValue, normToNegs=True):
    ...
    if normToNegs == True:  # negative control in combinedCountsPseudo
    ...
    # Additional keyword arguments(countsRatio, growthValue, wtLog2E) to pass as keywords arguments to func, axis=1 means apply function to each row
